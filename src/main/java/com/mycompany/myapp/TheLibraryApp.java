...
public class TheLibraryApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(TheLibraryApp.class);

    private final Environment env;

    public TheLibraryApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes theLibrary.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(TheLibraryApp.class);
