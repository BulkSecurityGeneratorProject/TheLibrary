...
import com.mycompany.myapp.TheLibraryApp;
...
public class BookResourceIntTest {
    ...
    private static final BigDecimal DEFAULT_PRICW = new BigDecimal(1);
    private static final BigDecimal UPDATED_PRICW = new BigDecimal(2);
    ...
    public void createBook() throws Exception {
        ...
        assertThat(testBook.getPricw()).isEqualTo(DEFAULT_PRICW);
    ...
    public void getAllBooks() throws Exception {
        ...
        restBookMockMvc.perform(get("/api/books?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].pricw").value(hasItem(DEFAULT_PRICW.intValue())));
    }
    ...
    public void getBook() throws Exception {
        ...
        restBookMockMvc.perform(get("/api/books/{id}", book.getId()))
            ...
            .andExpect(jsonPath("$.pricw").value(DEFAULT_PRICW.intValue()));
    }
    ...
    public void updateBook() throws Exception {
        ...
        assertThat(testBook.getPricw()).isEqualTo(UPDATED_PRICW);
